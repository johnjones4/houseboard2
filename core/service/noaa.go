...
func (c noaaConfiguration) Service() shared.Service {
	return &noaa{c}
}
...
func (f *noaa) predictWeather(coord shared.Coordinate) (Weather, error) {
...
func makeWeatherAPIPointRequest(coord shared.Coordinate) (noaaWeatherPointProperties, error) {
